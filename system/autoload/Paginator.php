...
//        }
        ...
        if($w1 != ''){
            ...
            $totalReq = ORM::for_table($table)->where('workspace_id',$workspace_id)->where_like($w1,$c1)->count();


        }
        elseif($w2 != ''){
            $totalReq = ORM::for_table($table)->where('workspace_id',$workspace_id)->where_like($w1,$c1)->where($w2,$c2)->count();
        }

        elseif($w3 != ''){
            $totalReq = ORM::for_table($table)->where('workspace_id',$workspace_id)->where($w1,$c1)->where($w2,$c2)->where($w3,$c3)->count();
        }

        elseif($w4 != ''){
            $totalReq = ORM::for_table($table)->where('workspace_id',$workspace_id)->where($w1,$c1)->where($w2,$c2)->where($w3,$c3)->where($w4,$c4)->count();
        }
