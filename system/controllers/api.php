            ...
            case 'customers':
                ...
                switch ($method){
                    ...
                    case 'GET':
                        ...
                        jsonResponse(Contact::orderBy('id','desc')->where('workspace_id',$user->workspace_id)->get()->toArray());
            ...
            case 'customer':
                ...
                switch ($method){
                    ...
                    case 'GET':
                        ...
                        $contact = Contact::where('workspace_id',$user->workspace_id)->find($id)->toArray();
