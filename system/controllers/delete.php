...
switch ($action) {
    ...
    if($d){
        $username = $d->account;
//delete all activity
        $x = ORM::for_table('sys_activity')->where('workspace_id',$workspace_id)->where('cid',$id)->delete_many();
        $x = ORM::for_table('sys_invoices')->where('workspace_id',$workspace_id)->where('userid',$id)->delete_many();
        $x = ORM::for_table('sys_quotes')->where('workspace_id',$workspace_id)->where('userid',$id)->delete_many();
        $x = ORM::for_table('sys_orders')->where('workspace_id',$workspace_id)->where('cid',$id)->delete_many();
        $x = ORM::for_table('sys_staffpermissions')->where('workspace_id',$workspace_id)->where('rid',$id)->delete_many();
        $x = ORM::for_table('ib_doc_rel')->where('workspace_id',$workspace_id)->where('rtype','contact')->where('rid',$id)->delete_many();

        // Delete credit card info if exist

        $credit_card = CreditCard::where('contact_id',$id)->where('workspace_id',$workspace_id)->first();
    ...
    $d = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->find_one($id);
    if($d){
        $type = $d['type'];
        $r = 'ps/s-list';
        if($type == 'Product'){
...
//delete all invoice items
            ...
            $items = InvoiceItem::where('invoiceid',$id)->where('workspace_id',$workspace_id)->get();
          ...
          //  $x = ORM::for_table('sys_invoiceitems')->where('invoiceid',$id)->delete_many();
            ...
            $transactions = Transaction::where('iid',$id)->where('workspace_id',$workspace_id)->get();
    ...
    case 'quote':
        ...
        $id = $routes['2'];
        $id = str_replace('iid','',$id);
        $d = ORM::for_table('sys_quotes')->where('workspace_id',$workspace_id)->find_one($id);
        if($d){
//delete all invoice items
            $x = ORM::for_table('sys_quoteitems')->where('qid',$id)->where('workspace_id',$workspace_id)->delete_many();
    ...
    case 'tags':
        $id = $routes['2'];
        $id = str_replace('iid','',$id);
        $d = ORM::for_table('sys_tags')->where('workspace_id',$workspace_id)->find_one($id);
        if($d){
//delete all invoice items
    ...
    case 'tax':
        $id = $routes['2'];
        $id = str_replace('t','',$id);
        $d = ORM::for_table('sys_tax')->where('workspace_id',$workspace_id)->find_one($id);
        if($d){
    ...
    case 'currency':
        ...
        if($c){
            ...
            $check = $invoice->where('currency',$id)->where('workspace_id',$workspace_id)->find_one();
            ...
            r2(U.'settings/currencies/','s',$_L['delete_successful']);
    ...
    case 'company':
        ...
        $c = $company->where('workspace_id',$workspace_id)->find_one($id);
    ...
    case 'event':
        ...
        $calendar = M::factory('Models_Calendar')->where('workspace_id',$workspace_id)->find_one($id);
    ...
    case 'role':
        ...
        if($role){
            ...
            $users = M::factory('Models_User')->where('workspace_id',$workspace_id)->where('roleid',$id)->find_one();
    ...
    case 'order':
        ...
        $d = ORM::for_table('sys_orders')->where('workspace_id',$workspace_id)->find_one($id);
    ...
    case 'document':
        ...
        $d = ORM::for_table('sys_documents')->where('workspace_id',$workspace_id)->find_one($id);
        ...
        if($d){
            ...
            $rel = ORM::for_table('ib_doc_rel')->where('workspace_id',$workspace_id)->where('did',$id)->delete_many();
    ...
    case 'lead':
        ...
        $lead = ORM::for_table('crm_leads')->where('workspace_id',$workspace_id)->find_one($id);
    ...
    case 'multiple':
        ...
        switch ($type){
            ...
            case 'customers':
                ...
                $contacts = ORM::for_table('crm_accounts')->where('workspace_id',$workspace_id)->where_id_in($ids)->delete_many();
    ...
    case 'purchase':
        ...
        if($d){
//delete all invoice items
            $x = ORM::for_table('sys_purchaseitems')->where('workspace_id',$workspace_id)->where('invoiceid',$id)->delete_many();
