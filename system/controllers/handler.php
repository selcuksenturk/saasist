...
_L[\'Email Sent\'] = \''.$_L['Email Sent'].'\';
 ');
    ...
    case 'view_email_templates':
        ...
        $tpls = ORM::for_table('sys_email_templates')->where('workspace_id',$workspace_id)->select('id')->select('core')->select('tplname')->select('subject')->order_by_desc('id')->find_array();
    ...
    case 'json_eml_tpl':
        ...
        $eml = ORM::for_table('sys_email_templates')->where('workspace_id',$workspace_id)->find_one($id);
