...
_L[\'are_you_sure\'] = \''.$_L['are_you_sure'].'\';
 ');
        ...
        $mode_js = '';
            ...
            $d = ORM::for_table('sys_orders')->where('workspace_id',$workspace_id)->order_by_desc('id')->find_many();
 ...
 ');
    ...
    case 'post':
        ...
        $p = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->find_one($pid);
        ...
        $c = ORM::for_table('crm_accounts')->where('workspace_id',$workspace_id)->find_one($cid);
    ...
    case 'view':
        ...
        $order = ORM::for_table('sys_orders')->where('workspace_id',$workspace_id)->find_one($oid);
...
_L[\'email_sent\'] = \''.$_L['Email Sent'].'\';
 ...
 ';
    ...
    case 'save_activation':
        ...
        $d = ORM::for_table('sys_orders')->where('workspace_id',$workspace_id)->find_one($oid);
        ...
        if($d){
            ...
            if($send_email == 'yes'){
                ...
                $client = ORM::for_table('crm_accounts')->where('workspace_id',$workspace_id)->find_one($cid);
