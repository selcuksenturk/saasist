...
switch ($action) {
    ...
    case 'modal-list':
        ...
        $d = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->order_by_asc('name')->find_array();
...
';
    ...
    case 'p-new':
        ...
        $ui->assign('xfooter', Asset::js(array('modal','dropzone/dropzone','redactor/redactor.min','numeric')));
 ...
 ');
    ...
    case 'add-post':
        ...
        if($item_number != ''){
            $check = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->where('item_number',$item_number)->find_one();
            if($check){
...
//        }
    ...
    case 'p-list':
        ...
        $d = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->where('type','Product')->offset($paginator['startpoint'])->limit($paginator['limit'])->order_by_desc('id')->find_many();
        $ui->assign('d',$d);
        $ui->assign('type','Product');
...
//');
    ...
    case 's-list':
        ...
        $d = ORM::for_table('sys_items')->where('workspace_id',$workspace_id)->where('type','Service')->offset($paginator['startpoint'])->limit($paginator['limit'])->order_by_desc('id')->find_many();
        $ui->assign('d',$d);
        $ui->assign('type','Service');
        $ui->assign('paginator',$paginator);
//        $ui->assign('xheader', '
