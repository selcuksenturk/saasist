...
if(isset($config['plan']))
{
    ...
    if($workspace_plan)
    {
        ...
        if(!isset($enabled_modules['documents']))
        {
            permissionDenied();
        }
...
dl_token = $(this).attr("data-token")
 ...
 ';
        ...
        $d = ORM::for_table('sys_documents')->where('workspace_id',$workspace_id)->find_array();
        $ui->assign('d',$d);
    ...
    case 'download':
        ...
        $doc = ORM::for_table('sys_documents')->where('workspace_id',$workspace_id)->find_one($id);
    ...
    case 'set_global':
        ...
        $doc = ORM::for_table('sys_documents')->where('workspace_id',$workspace_id)->find_one($did);
