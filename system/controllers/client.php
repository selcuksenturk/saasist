...
switch ($action) {
    ...
    case 'iview':
        ...
        if($d){
	        ...
	        $config = getConfig($d->workspace_id);
...
//find the user
	        ...
	        $cf = ORM::for_table('crm_customfields')
	                 ->where('workspace_id',$d->workspace_id)
	                 ->where('showinvoice','Yes')->order_by_asc('id')->find_many();
            ...
            switch ($pg){
                ...
                case 'paypal':
                    ...
                    if($p){
                        ...
                        $currency_find = M::factory('Models_Currency')
                                          ->where('workspace_id',$d->workspace_id)
...
//                        );
                ...
                case 'stripe':
                    ...
                    $p = ORM::for_table('sys_pg')->where('workspace_id',$d->workspace_id)
...
//                        $ui->assign('ins',$ins);
                ...
                case 'stripe_post':
	                ...
	                $p = ORM::for_table('sys_pg')
	                        ->where('workspace_id',$d->workspace_id)
	                        ->where('processor', 'stripe')->find_one();
	                if($p){
		                $a = ORM::for_table('crm_accounts')->find_one($d['userid']);
		                $it = $i_total - $i_credit;
		                $amount = $it*100;
...
//            $mail->Send();
    ...
    case 'register_post':
       ...
       // sleep(3);
	    ...
	    r2(U.'client/register/','e','Client Registration is Disabled.');
...
vMax: \'9999999999999999.00\',
 ...
 ';
    ...
    case 'new-order':
        ...
        $ui->assign('items',ORM::for_table('sys_items')
