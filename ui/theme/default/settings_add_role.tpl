            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{$_url}settings/add_role_post/" method="post" accept-charset="utf-8">
                        <div class="form-group"><label for="rname" class="control-label"> <small class="req text-danger">* </small>{$_L['Name']}</label><input type="text" id="rname" name="rname" class="form-control" autofocus></div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered roles no-margin">
                                    ...
                                    <tr>
                                        ...
                                        <th class="bold">{$_L['All Data']} <br><small>{$_L['view all data or only self created data']}</small></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    {foreach $permissions as $permission}
                                        ...
                                        <tr data-id="{$permission['id']}">
                                            ...
                                            <td class="bold">
                                                ...
                                                {if $permission['pname'] == 'Bank & Cash'}

                                                    {$_L['Bank n Cash']}

                                                {elseif $permission['pname'] == 'Products & Services'}
                                                ...
                                                {else}
                                                    ...
                                                    {ib_lan_get_line($permission['pname'])}
