            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form role="form" name="localisation" method="post" action="{$_url}settings/lc-post/">
                        ...
                        <div class="form-group">
                            <label for="df">{$_L['Calendar first day']}</label>
                            <select class="form-control" name="calendar_first_day" id="calendar_first_day">

                                <option value="0" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '0'} selected="selected" {/if}>{$_L['Sunday']}</option>
                                <option value="1" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '1'} selected="selected" {/if}>{$_L['Monday']}</option>
                                <option value="2" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '2'} selected="selected" {/if}>{$_L['Tuesday']}</option>
                                <option value="3" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '3'} selected="selected" {/if}>{$_L['Wednesday']}</option>
                                <option value="4" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '4'} selected="selected" {/if}>{$_L['Thursday']}</option>
                                <option value="5" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '5'} selected="selected" {/if}>{$_L['Friday']}</option>
                                <option value="6" {if isset($config['calendar_first_day']) && $config['calendar_first_day'] eq '6'} selected="selected" {/if}>{$_L['Saturday']}</option>
