                    ...
                    <div class="tab-pane active show">
                        <div class="panel-body panel-body-with-border" style="background-color: #fff;">
                                                    ...
                                                    <div class="ibox-content">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 text-right">
                                                                <a href="{$_url}transactions/bill/{$bill->uuid}" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-file-text-o"></i></a>
                                                                {if $bill->website != ''}
                                                                ...
                                                                {/if}
                                                                <a href="javascript:;" onclick="confirmThenGoToUrl(event,'transactions/delete-bill/{$bill->uuid}');" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Delete']}"><i class="fa fa-trash-o"></i></a>
                                                                {if $bill->is_paid == 0}
                                                                    <a href="javascript:;" onclick="confirmThenGoToUrl(event,'transactions/bill-mark-as-paid/{$bill->uuid}');" class="btn btn-green btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Mark as Paid']}"><i class="fa fa-check"></i></a>
                                                                {/if}
                                                            </div>
                                                        </div>
                                                        <a href="{$_url}transactions/bill/{$bill->uuid}"><h4>{$bill->title}</h4></a>
                            ...
                            <div class="row">
                                    ...
                                    {foreach $bills_past_due as $bill}
                                        <div class="col-lg-3">
                                            <div class="ibox" style="box-shadow: none; border-radius: 0; border: 1px solid #e2e9ec;">
                                                <div class="ibox-content">
                                                    <div class="row">
