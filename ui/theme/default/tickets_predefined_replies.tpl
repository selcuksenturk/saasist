...
{block name="content"}
        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>{$_L['Predefined Replies']}</h5>

                </div>
                <div class="ibox-content">
                    <a data-toggle="modal" href="#modal_add_item" class="btn btn-success mb-md"><i class="fa fa-plus"></i> {$_L['Add Predefined Reply']}</a>

                    <a href="{$_url}tickets/admin/predefined_replies_reorder/" class="btn btn-primary mb-md"><i class="fa fa-arrows"></i> {$_L['Reorder']}</a>
                    <br>
    ...
    <div id="modal_add_item" class="modal fade" tabindex="-1" data-width="600" style="display: none;">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">{$_L['Add Predefined Reply']}</h4>
        </div>
