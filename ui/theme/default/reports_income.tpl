                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} " data-p-sign="{$config['currency_symbol_position']}">{$total_income_all_time}</span>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-p-sign="{$config['currency_symbol_position']}" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'current_month',$all_data)}</span>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-p-sign="{$config['currency_symbol_position']}" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'current_week',$all_data)}</span>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-p-sign="{$config['currency_symbol_position']}" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'last_30_days',$all_data)}</span>
                                        </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        {foreach $d as $ds}
                            <tr>
                                ...
                                <td class="text-right amount" data-a-sign="{$currency->symbol} " data-p-sign="{$config['currency_symbol_position']}">{$ds['cr']}</td>
