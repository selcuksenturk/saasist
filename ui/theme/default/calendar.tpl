...
{block name="script"}
    ...
    <script type="text/javascript" src="{$app_url}ui/lib/fc/lang/{getFCLocale($user->language)}.js"></script>
    ...
    <script>
        $(function() {
            ...
            var ib_calendar_options = {
                ...
                lang: '{getFCLocale($user->language)}',
                {if isset($config['calendar_first_day'])}
                firstDay: {$config['calendar_first_day']},
                {/if}
            };
