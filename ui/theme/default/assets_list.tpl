                    ...
                    <div class="file-manager">
                        ...
                        <ul class="folder-list" style="padding: 0">
                            ...
                            {foreach $categories as $category}
                                <li><a href="{$_url}assets/list/{$category->uuid}"><i class="fa fa-folder"></i> {$category->name}</a></li>
                            {/foreach}
                        </ul>
                        ...
                        {if $selected_category}
                            <a href="javascript:;" onclick="confirmThenGoToUrl(event,'delete/asset-category/{$category->uuid}');" class="btn btn-danger btn-block">{$_L['Delete']}</a>
                        {/if}
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-hover sys_table footable" data-filter="#foo_filter" data-page-size="50">
                        ...
                        {foreach $assets as $asset}
                            <tr>
                                <td><a href="{$_url}assets/asset/{$asset->uuid}">{$asset->name}</a> </td>
